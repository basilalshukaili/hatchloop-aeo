...
function App() {
  let { apiKey, isMock, tidioKey } = useLoaderData();
  return /* @__PURE__ */ jsxs("html", { lang: "en", children: [
    ...
    /* @__PURE__ */ jsxs("body", { children: [
      ...
      !isMock && tidioKey ? /* @__PURE__ */ jsx2("script", { src: `//code.tidio.co/${tidioKey}.js`, async: !0 }) : null
    ] })
  ] });
}
...
var _genLog = /* @__PURE__ */ new Map(), GEN_WINDOW_MS = 10 * 60 * 1e3, GEN_MAX = 40;
